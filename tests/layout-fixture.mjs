...
const pane=document.querySelector('.pane'), content=document.querySelector('.source-minimap-content'),container=document.querySelector('.source-minimap-container');
...
body{font:16px Arial;background:#191919;color:#ddd}h1{font-size:20px}.pane{position:relative;height:370px;border:1px solid #555;background:#202020}.markdown-source-view{height:100%}.cm-scroller{height:100%;box-sizing:border-box;overflow:auto;padding:24px;display:flex}.cm-sizer{flex:1;min-width:0}.cm-content{font:16px/24px monospace;tab-size:4;letter-spacing:0}.cm-line{white-space:pre-wrap;overflow-wrap:break-word;word-break:normal}.source-minimap-content{box-sizing:border-box;font:16px/24px monospace;color:#ddd}pre{font-size:12px}.source-minimap-container{--source-minimap-scale:.1;--source-minimap-text-opacity:.55}
${css}</style><h1>Source-mode layout checks</h1><button>Run resize checks</button><p id="status"></p><div class="pane"><div class="markdown-source-view mod-cm6"><div class="cm-scroller"><div class="cm-sizer"><div class="cm-content"></div></div></div></div><div class="source-minimap-container"><div class="source-minimap-viewport"><div class="source-minimap-content source-minimap-content-source"></div></div><div class="source-minimap-hitbox"></div></div></div><pre></pre><script>${js.outputFiles[0].text}</script>`;
await writeFile('/tmp/source-minimap-layout.html',html);
